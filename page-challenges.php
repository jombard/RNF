...
get_header(); ?>
	...
	<div class="row">
	    ...
	    <div class="col-md-8">
	        ...
	        <p>Are you taking on a challenge and looking for a charity to fundraise for? 
	        ...
	        <nav class="primary clearfix">
	            <ul>
	                ...
	                <li><a href="#" data-filter=".rnfswim">Swimming</a></li>
	                <li><a href="#" data-filter=".rnfbike">Biking</a></li>
	                <li><a href="#" data-filter=".rnfrun">Running</a></li>
	                <li><a href="#" data-filter=".rnftrek">Trekking</a></li>
	                <li><a href="#" data-filter=".rnfquiz">Quizzing</a></li>
	                <li><a href="#" data-filter=".rnfskydive">Skydiving</a></li>
	                <li><a href="#" data-filter=".rnfother">Fun Stuff</a></li>
	            </ul>
	        </nav>
	        ...
	        <div class="alert alert-info">
		        <p>For regular updates on other challenges and events <a href="/fundraising/fundraising-for-us/">sign up to our mailing list</a>, <a rel="noopener noreferrer" href="https://www.facebook.com/pages/Remembering-Not-To-Forget/235169236658679" target="_blank">like us on Facebook</a> or <a rel="noopener noreferrer" href="https://twitter.com/RNF_UK" target="_blank">follow us on Twitter</a>.</p>
	        </div>
